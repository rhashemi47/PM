...
public class SyncWsAcceptWorkList {
	...
	//Contractor
	public SyncWsAcceptWorkList(Context activity, String PersonCode, boolean toast, boolean proccessbar, boolean notifi) {
	...
	public boolean checkCode(String codeStr)
	{
		...
		String query = "SELECT * FROM AcceptWork WHERE Code='" + codeStr + "'";
