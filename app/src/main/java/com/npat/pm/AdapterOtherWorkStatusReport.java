...
@SuppressLint("NewApi")
public class AdapterOtherWorkStatusReport extends BaseAdapter {
    ...
    public AdapterOtherWorkStatusReport(Activity activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    private View.OnClickListener TextViewItemOnclick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(activity.getApplicationContext(),ReportOtherWorkStatus.class);
