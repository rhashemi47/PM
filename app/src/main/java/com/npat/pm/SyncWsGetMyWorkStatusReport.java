...
public class SyncWsGetMyWorkStatusReport {
	...
	//Contractor
	public SyncWsGetMyWorkStatusReport(Context activity,
									   String PersonCode,
									   String FromDate,
									   String ToDate,
									   String Mobile,
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	...
        	if(result == null)
        	{
	            ...
	            {
	            	Toast.makeText(this.activity.getApplicationContext(), "موردی یافت نشد", Toast.LENGTH_LONG).show();
	            }
