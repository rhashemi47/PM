...
public class GetWsOtherWorkStatusReport {
	...
	//Contractor
	public GetWsOtherWorkStatusReport(Activity activity, String PersonCode,boolean toast,boolean proccessbar, boolean notifi) {
