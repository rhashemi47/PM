...
public class SyncGetListHamkaran {
	...
	//Contractor
	public SyncGetListHamkaran(Context activity, String PersonCode, boolean toast, boolean proccessbar) {
	...
	public void CallWsMethod(String METHOD_NAME) {
	    ...
	    //Set Name
		UserCodePI.setName("PersonCode");
	    //Set Value
		UserCodePI.setValue(this.PersonCode);
	    //Set dataType
