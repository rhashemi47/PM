...
@SuppressLint("NewApi")
public class AdapterListRequest extends BaseAdapter {
    ...
    public AdapterListRequest(Activity activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    private View.OnClickListener TextViewItemOnclick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(activity.getApplicationContext(),MyRequest.class);
